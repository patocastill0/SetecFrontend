...
@Component({
  selector: 'app-paginadortrabajadores',
  templateUrl: './paginadortrabajadores.component.html',
  styleUrls: ['./paginadortrabajadores.component.css']
})
export class PaginadortrabajadoresComponent implements OnInit {
